<div class="row" id="home">
  ...
  <div class="row profile-area">
      <div class="col s6 m6 profile-1">
        <img src="<?php echo base_url(); ?>html/images/female.jpeg" class="responsive-img">
      </div>
      <span class="heart"><img src="<?php echo base_url() ?>html/images/wedHeart-small.png"></span>
      <div class="col s6 m6 profile-1">
        <img src="<?php echo base_url(); ?>html/images/male.jpeg" class="responsive-img">
      </div>
  </div>
  </div>
  ...
  <!-- <div class="row banner-row">
		<div class="heart">
			<img class="with" src="<?php //echo base_url(); ?>html/images/h.png">
		</div>
  	<div class="banner-box1 col s6 m6">
...
<!---====================card 2=========================-->
        ...
        <div class="event-time-container">
        	...
        	<div class="time-details">
        		<div class="time-date">4TH JANUARY- 2018</div>
        		<div class="time-time">12:30 PM</div>
        	</div>
        </div>
...
<!---====================card 2=========================-->
        ...
        <div class="event-time-container">
        	...
        	<div class="time-details">
        		<div class="time-date">4TH JANUARY- 2018</div>
        		<div class="time-time">2:30 PM</div>
        	</div>
        </div>
